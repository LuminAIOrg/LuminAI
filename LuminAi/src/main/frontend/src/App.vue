...
<template>
  <div class="w-screen h-screen flex ">
    ...
    <div class="relative flex justify-start left-0 top-0">
      <div class="absolute -z-10 w-full ">
          <svg class="h-full min-w-fit overflow-hidden" height="569" viewBox="0 0 1520 569" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="w-screen relative mx-52 mt-14">
      ...
      <div>
        ...
        <div class="w-full flex justify-center">
          ...
          <div class="columns-2 gap-x-20 w-full pb-5">
